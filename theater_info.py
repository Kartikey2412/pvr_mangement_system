...
class seats:
    ...
    def __init__(self):
        print("Movie :  Drishyam 2\n")
        print("Date :  30 Nov\n")
        print("time :  12 PM\n")

        self.no_of_rows = int(input("Enter the Number of Rows:"))
        self.no_of_seats = int(input("Enter the Number of Columns:"))
...
class tickets:
    ...
    def buy_ticket(self, total_seats, no_of_rows,total_income,total_seats_booked ):
        ...
        if confirmation == 'Yes' or confirmation=='yes':
            ...
            matrix[self.book_row - 1][self.book_column - 1] = "O"
